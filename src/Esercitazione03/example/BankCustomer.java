...
public class BankCustomer implements Runnable{
    ...
    private final static int MIN_WAITING = 1;
    private final static int MAX_WAITING = 3;
    ...
    public BankCustomer(int amount, int number, BankAccount ba){
        if(number % 2 != 0)
            throw new RuntimeException("Operations must be even.");
