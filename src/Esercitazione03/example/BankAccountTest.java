...
public class BankAccountTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        BankAccount account = new BankAccountAtomic(
                STARTING_AMOUNT);
        ...
        System.out.println("Starting balance: " + STARTING_AMOUNT + ", current balance: " + account.getBalance());
        System.out.println("Difference: " + (STARTING_AMOUNT - account.getBalance()));
    }

    private static void startTest(BankAccount account, int customersNumber, int amount, int operationsNumber) throws InterruptedException {
